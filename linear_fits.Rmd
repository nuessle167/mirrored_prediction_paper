...
plot(H_2a_Data_unknown$Plateau.E_iso~H_2a_Data_unknown$Prompt.E_iso, pch=20, main=paste(strwrap('Isotropic Energy Relationship for GRBs', width = 50), collapse = "\n"), xlab='Prompt Isotropic Energy 10kev-10MeV (erg, GBM)', ylab=paste(strwrap('Plateau Afterglow Isotropic Energy 0.2-10 keV (erg, XRT)', width = 50), collapse = "\n"), log="xy")
...
plot(Goldstein_S2_unknown$t90, Goldstein_S2_unknown$`Peak E. over Flue.`, pch=20, main=paste(strwrap('Amati Relation-Derived Split for Fermi-GBM GRBs', width = 50), collapse = "\n"), ylab=paste(strwrap('Peak Energy over Fluence 10kev-10MeV (erg cm^2 erg^-1, GBM)', width = 50), collapse = "\n"), xlab='t90 (s, GBM)', log="xy")
points(Goldstein_S2_mergers$t90, Goldstein_S2_mergers$`Peak E. over Flue.`, pch=11, col='red')
...
merger_mask<-which(new_Goldstein_S2_Data$as.factor.Classification.==1)
collapsar_mask<-which(new_Goldstein_S2_Data$as.factor.Classification.==2)
...
print(svmfit)
plot(svmfit, training_set, Peak_E_over_Flu~t90, ylab=paste(strwrap('Peak Energy over Fluence 10kev-10MeV (erg cm^2 erg^-1, GBM)', width = 50), collapse = "\n"), xlab='t90 (s, GBM)', log="xy", xlim=c(-2, 5), ylim=c(5, 13))
...
plot(new_Goldstein_S2_Data[unknown_remover, ]$Peak_E_over_Flu~new_Goldstein_S2_Data[unknown_remover, ]$t90, ylab=paste(strwrap('Peak Energy over Fluence 10kev-10MeV (erg cm^2 erg^-1, GBM)', width = 50), collapse = "\n"), xlab='t90 (s, GBM)', col=predicted_svm, pch=20)
points(Goldstein_S2_mergers$t90, Goldstein_S2_mergers$`Peak E. over Flue.`, pch=11, col='green')
points(Goldstein_S2_collapsars$t90, Goldstein_S2_collapsars$`Peak E. over Flue.`, pch=8, col='blue')
###
...
Second_predicted_svm<-predict(svmfit, new_Goldstein_S6_Data[unknown_remover, ])
plot(new_Goldstein_S6_Data$Peak_E_over_Flu~new_Goldstein_S6_Data$t90,ylab=paste(strwrap('Peak Energy over Fluence 10kev-10MeV (erg cm^2 erg^-1, GBM)', width = 50), collapse = "\n"), xlab='t90 (s, GBM)', col=Second_predicted_svm, pch=20)
