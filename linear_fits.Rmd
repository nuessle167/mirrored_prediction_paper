...
plot(Gehrels_S3_unknown$Prompt_Flu, Gehrels_S3_unknown$`X-ray_F11`, pch=20, xlab=expression('Prompt Fluence 10kev-10MeV (erg'~cm^{-2}~', GBM)'), ylab=expression('Afterglow Flux at 11 Hrs. 10kev-10MeV 0.2-10 keV (erg'~cm^{-2}~s^{-1}~', XRT)'), log="xy", xlim = c(1e-7, 1e-3), ylim = c(1e-20, 1e-8))
...
plot(Gehrels_S3_Long$Prompt_Flu, Gehrels_S3_Long$`X-ray_F11`, pch=20, col='black', xlab=expression('Prompt Fluence 10kev-10MeV (erg'~cm^{-2}~', GBM)'), ylab=expression('Afterglow Flux at 11 Hrs. 0.2-10 keV (erg'~cm^{-2}~s^{-1}~', XRT)'), log="xy", xlim = c(1e-7, 1e-3), ylim = c(1e-20, 1e-8))
...
legend("bottomleft",
       ...
       pch = c(20, 20, 4, 8))
##
modGehrels<-lm(log10(Gehrels_S3_Data$`X-ray_F11`)~log10(Gehrels_S3_Data$Prompt_Flu))
par(mfrow=c(2,2))
plot(modGehrels)
print(anova(modGehrels))
print(summary(modGehrels))
#
modGehrels2<-lm(log10(Gehrels_S3_Data$`X-ray_F11`)~log10(Gehrels_S3_Data$Prompt_Flu)+log10(Gehrels_S3_Data$t90))
par(mfrow=c(2,2))
plot(modGehrels2)
print(anova(modGehrels2))
print(summary(modGehrels2))
#
modGehrels3<-lm(log10(Gehrels_S3_Long$`X-ray_F11`)~log10(Gehrels_S3_Long$Prompt_Flu))
par(mfrow=c(2,2))
plot(modGehrels3)
...
plot(Gehrels_S6_unknown$Prompt_E_iso, Gehrels_S6_unknown$`X-ray_F11`, pch=20,  xlab=expression('Prompt E_iso 10kev-10MeV (erg, GBM)'), ylab=expression('Afterglow Flux at 11 Hrs. 10kev-10MeV 0.2-10 keV (erg'~cm^{-2}~s^{-1}~', XRT)'), log="xy", ylim = c(1e-16, 1e-8))
...
plot(Gehrels_S6_Long$Prompt_E_iso, Gehrels_S6_Long$`X-ray_F11`, pch=20, col='black', xlab=expression('Prompt E_iso 10kev-10MeV (erg, GBM)'), ylab=expression('Afterglow Flux at 11 Hrs. 10kev-10MeV 0.2-10 keV (erg'~cm^{-2}~s^{-1}~', XRT)'), log="xy", ylim = c(1e-16, 1e-8))
...
legend("bottomleft",
       ...
       pch = c(20, 20, 8))
##
modGehrels<-lm(log10(Gehrels_S6_Data$`X-ray_F11`)~log10(Gehrels_S6_Data$Prompt_E_iso))
par(mfrow=c(2,2))
plot(modGehrels)
print(anova(modGehrels))
print(summary(modGehrels))
#
modGehrels2<-lm(log10(Gehrels_S6_Data$`X-ray_F11`)~log10(Gehrels_S6_Data$Prompt_E_iso)+log10(Gehrels_S6_Data$t90))
par(mfrow=c(2,2))
plot(modGehrels2)
print(anova(modGehrels2))
print(summary(modGehrels2))
#
modGehrels3<-lm(log10(Gehrels_S6_Long$`X-ray_F11`)~log10(Gehrels_S6_Long$Prompt_E_iso))
par(mfrow=c(2,2))
plot(modGehrels3)
print(anova(modGehrels3))
print(summary(modGehrels3))
